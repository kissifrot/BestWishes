...
class UserData extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $password = $this->encoder->encodePassword($standardUser1, 'user1');
        ...
        $password = $this->encoder->encodePassword($standardUser2, 'user2');
        ...
        $password = $this->encoder->encodePassword($standardUser3, 'user3');
